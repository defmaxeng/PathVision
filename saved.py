...
>>>>>>> 957dbe9 (Began developing systems to test parameters in training the convolutional neural network)
...
<<<<<<< HEAD
=======
def reinitialize_model(model_dir):
    shutil.rmtree(f"{model_dir}")
    print("Deleted: ", f"{model_dir}")
...
=======
        ...
        if nan_detected:
            model, optimizer = reinitialize_model(model_dir)
